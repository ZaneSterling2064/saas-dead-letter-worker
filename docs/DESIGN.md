...
> Design notes for **saas-dead-letter-worker** — a runnable rust example that Route exhausted tenant onboarding, account lifecycle, and admin jobs into a dead-letter queue with typed Rust errors.
...
- **Feature code** — the actual task: saas-dead-letter-handling.
